...
InfoBox.prototype.createElement = function() {
  ...
  if (!div) {
    ...
    //div.style.background = "url('http://off.theorigo.com/bossini-corp-v3/images/map-bubble.gif')";
    div.style.width = this.width_ + "px";
    div.style.height = this.height_ + "px";
    var contentDiv = document.createElement("div");
    //contentDiv.style.padding = "-20px 0 0 0"
    ...
    closeImg.style.marginTop = "8px";
    closeImg.style.marginRight = "8px";
    closeImg.style.float = "right";
    closeImg.style.cursor = "pointer";
    closeImg.src = "http://behappy.dev.theorigo.com/assets/images/closebigger.png";
